...
# # directory_path = rf'C:\Users\ththy\Desktop\Stage_Thales\birds_simulation_V_shape\Dataset'
...
#         output = rf'C:\Users\ththy\Desktop\Stage_Thales\Trajectories_to_move_to_digital_twin\dataset_in_json_format\drones_dataset'
#         output_final = os.path.join(output, directory)
#         print(output_final)
#         if not os.path.exists(output):
#             os.makedirs(output_final)
#             # pylint: disable=f-string-without-interpolation
#             print(f'directory created {output_final}')

#         path = os.path.join(directory_path, directory, "Data_processed")
#         files = [f for f in os.listdir(path) if os.path.isfile(os.path.join(path, f)) and f.endswith('.csv')]
#         for file in files:
#             path_file = os.path.join(path, file)
#             print("\n",path_file, "---------------------------------------- \n")
#             convert_into_json(path_file, os.path.join(output_final, file))
